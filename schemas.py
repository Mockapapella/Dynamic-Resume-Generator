...
class ResumeSchema(BaseModel):
    """Model for validating the complete resume structure."""

    ApplicationInfo: ApplicationInfo
    General: General
    Jobs: dict[str, Jobs] = Field(default_factory=dict)
    Education: dict[str, Education] = Field(default_factory=dict)
    LicensesAndCertifications: dict[str, LicensesAndCertifications] = Field(default_factory=dict)
    VolunteerExperience: dict[str, VolunteerExperience] = Field(default_factory=dict)
    Projects: dict[str, Projects] = Field(default_factory=dict)
    HonorsAndAwards: dict[str, HonorsAndAwards] = Field(default_factory=dict)
